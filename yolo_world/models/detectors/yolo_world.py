...
from .transformer import MultiHeadTransformer
...
class YOLOWorldDetector(YOLODetector):
    ...
    def __init__(self,
        ...
        self.qformer = QFormer(num_heads=2, num_layers=2)
    ...
    def extract_feat(
        ...
        #     processed_img_feat = self.qformer(img_feat, txt_feats)
        #     processed_img_feats.append(processed_img_feat)
        
        # img_feats = tuple(processed_img_feats)
            
        model = MultiHeadTransformer(num_heads=2)
        img_feats = model(img_feats)
